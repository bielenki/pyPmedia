    ...
    def runThiessen(self):
        ...
        if result:
            ...
            for x in range(1,len(consulta)):
                ...
                saida_thiessen=r"\Thiessen_combinacao_" + str(combinacao_sel[x])+".shp"#nome para os arquivos de poligonos de saida
                saida_thiessen_Clip=r"\Thiessen_combinacao_" + str(combinacao_sel[x])+"_Clip.shp" #nome para os arquivos de poligonos clipados de saida
                ...
                parameters['layerThiessenTemp'] = self.projectPath + saida_thiessen
                parameters['layerClipTemp'] = self.projectPath + saida_thiessen_Clip
